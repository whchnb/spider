...
class Public(object):
    ...
    def get_headers(self):
        headers = {
            ...
            'method': 'GET',
            # 'path': '/product/managementproducts/asyQueryProductsList.do?showType=onlyMarket&status=all&page=1&size=10&statisticsType=month&repositoryType=all&imageType=all&ctoken=ou8l8wrky_9l',
            'scheme': 'https',
            'accept': '*/*',
            ...
            'cookie': self.cookie,
            'referer': 'https://hz-productposting.alibaba.com/product/products_manage.htm',
